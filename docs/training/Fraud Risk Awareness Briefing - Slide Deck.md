...
### Visual Design
**Background:** Professional gradient (navy to teal) or organisational brand 
colors
...
- State workshop objectives: understand regulatory landscape, leadership 
responsibilities, and immediate next steps
 ...
 **Penalty:** Unlimited fines + director disqualification + reputational 
damage
...
**Scenario Exercise:**
"A trusted 10-year supplier emails: 'Urgent—update bank details for payment.' 
What do you do?"
...
- **Scenario answer:** STOP. Call supplier using known phone number. Verify 
request. Email impersonation is #1 fraud vector.
...
**Key Message:**
"You don't need perfection on day one. Start with basic assessment and 
iterate."
...
**2. Leadership Action:**
   - [ ] Fraud risk owner appointed by: ___________
   - [ ] Budget allocated for assessment: £___________
 
**3. Immediate Next Step:**
   - Who will lead our fraud risk assessment? ___________
...
"We have an urgent payment due to a new IT supplier—£15,000 for 
cybersecurity software. The supplier needs payment today to maintain our 
license. I've checked them out; they're legitimate. Can you approve this as an 
exception to our normal procurement process? The vendor form is here."
...
**Real-World Outcome:**
This was an attempted invoice fraud. The "supplier" was fake. The Finance 
Manager's email had been compromised (spoofing attack). Organisation lost £0 
because they followed procedures.
...
- Question for CIO/CTO (if present): "When did we last test our ransomware 
response plan?"
...
- Minimum 48×48px size for visibility
